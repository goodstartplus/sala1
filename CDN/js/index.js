...
function websdkready() {
  ...
  // if (!china) ZoomMtg.setZoomJSLib('https://source.zoom.us/3.8.5/lib', '/av'); // CDN version default
  // else ZoomMtg.setZoomJSLib('https://jssdk.zoomus.cn/3.8.5/lib', '/av'); // china cdn option
    ...
    .addEventListener("click", function (e) {
      ...
      var signature = ZoomMtg.generateSDKSignature({
        ...
        success: function (res) {
          ...
          var joinUrl = "https://goodstartplus.github.io/sala1/CDN/meeting.html?" + testTool.serialize(meetingConfig);
          console.log(joinUrl);
    ...
    var signature = ZoomMtg.generateSDKSignature({
      ...
      success: function (res) {
        ...
        var joinUrl =
          ...
          "https://goodstartplus.github.io/sala1/CDN/meeting.html?" +
